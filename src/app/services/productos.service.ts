...
export class ProductosService {
  ...
  private API_PRODUCTOS = 'assets/products'

  postProductos(producto: any): Observable<any> {
    return this.http.post(`${this.API_PRODUCTOS},json`, producto)
  }

  getProductos(): Observable<any> {
    return this.http.get(`${this.API_PRODUCTOS}.json`)
  }
  ...
  deleteProducto(id: string): Observable<any> {
    return this.http.delete(`${this.API_PRODUCTOS}/${id}.json`)
  }
